...
<script>
	...
	*/
	...
	// var str2 = 'ketang';
	var str = '2017';
	//console.log( 'miaov'+str+'ketang' );  // miaov2017ketang

	console.log( 'miaov'+str+'ketang' );

	var num1 = 1;
	var num2 = 2;

	console.log( 'miaov'+(num1+num2)+'ketang' ); // miaov3ketang
	...
	*/
	console.log( 1+'1' );
	console.log( 'miaov'+(1+1) );
	console.log( 1+1+"miaov" );
